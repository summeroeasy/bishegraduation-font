  ...
  <div>
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" label-width="80px">
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item v-if="flag == 'jiaoshi'" label="教师职称" prop="zhicheng">
            <el-input v-model="ruleForm.zhicheng" placeholder="教师职称" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item v-if="flag == 'jiaoshi'" label="研究方向" prop="yanjiuFangxiang">
            <el-input v-model="ruleForm.yanjiuFangxiang" type="textarea" :rows="3" placeholder="研究方向"
              clearable></el-input>
          </el-form-item>
        </el-col>

        <el-col :span="24">
          <el-form-item v-if="flag == 'jiaoshi'" label="曾获荣誉" prop="rongyu">
            <el-input v-model="ruleForm.rongyu" type="textarea" :rows="3" placeholder="曾获荣誉" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item v-if="flag == 'jiaoshi'" label="学术荣誉" prop="xueshuRongyu">
            <el-input v-model="ruleForm.xueshuRongyu" type="textarea" :rows="3" placeholder="学术荣誉" clearable></el-input>
          </el-form-item>
        </el-col>

        <el-col :span="24">
          <el-form-item v-if="flag == 'jiaoshi'" label="学科信息" prop="xuekeXinxi">
            <el-input v-model="ruleForm.xuekeXinxi" type="textarea" :rows="3" placeholder="学科信息" clearable></el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item v-if="flag == 'yonghu'" label='学院' prop="xueyuanTypes">
            <el-select v-model="ruleForm.xueyuanTypes" placeholder='请选择学院'>
              <el-option v-for="(item, index) in xueyuanTypesOptions" v-bind:key="item.codeIndex"
        ...
        <el-col :span="12">
          <el-form-item v-if="flag == 'yonghu'" label='班级' prop="banjiTypes">
            <el-select v-model="ruleForm.banjiTypes" placeholder='请选择班级'>
              <el-option v-for="(item, index) in banjiTypesOptions" v-bind:key="item.codeIndex" :label="item.indexName"
        ...
        <el-col :span="12">
          <el-form-item v-if="flag != 'users'" label="性别" prop="sexTypes">
            <el-select v-model="ruleForm.sexTypes" placeholder="请选择性别">
              <el-option v-for="(item, index) in sexTypesOptions" v-bind:key="item.codeIndex" :label="item.indexName"
                :value="item.codeIndex">
              </el-option>
            </el-select>
          </el-form-item>
